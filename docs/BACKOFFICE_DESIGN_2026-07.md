...
| **第11弾 研修後FU** ✅実装済み | BO-6 研修後フォローアップ: 受注×研修を母数にDBトリガーで自動追加(0076)。1/3/6ヶ月後Mtgの日程調整・実施・AI活用度(点)の進化・業務課題・ソリューション提案・アップセル(なし/提案中/受注)を追跡。`/app/bo/followups`、BOハブ/朝の期日通知にも横断表示 | M |
